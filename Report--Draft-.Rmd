...
We also need to merge different symbols for the same stock.
...
Firstly, we import the data and do some data cleaning. We drop the variable 
...
```{stata import_cleanning_stata, eval=FALSE}
...
<center>**Figure 2.1**. Time series plots of example stocks</center>
...
<center>**Figure 2.2**. PACF plots for choosing p</center>
...
<center>**Figure 2.3**. ACF plots for choosing q</center>
...
<center>**Figure 2.4**. Prediction plots</center>
...
<center>**Figure 2.5**. Forecast plots</center>
...
```{r, echo=FALSE,out.width="49%", out.height="20%",fig.cap=cap, fig.show='hold', fig.align='center'}
cap = "**Figure 4.1**. *Time series plots of ADANIPORTS*"

knitr::include_graphics("./Stata/vwap_date.png")
knitr::include_graphics("./Stata/volume_date.png")
knitr::include_graphics("./Stata/turnover_date.png")
``` 
...
```{r, echo=FALSE,out.width="49%", out.height="20%",fig.cap=cap, fig.show='hold', fig.align='center'}
cap = "**Figure 4.2**. *ACF and PACF plots of ADANIPORTS*"

knitr::include_graphics(c("./Stata/acf&pacf/pacf_ADANIPORTS.png",
                          "./Stata/acf&pacf/pacf_ASIANPAINT.png"))

knitr::include_graphics(c("./Stata/acf&pacf/pacf_AXISBANK.png",
                          "./Stata/acf&pacf/pacf_BAJAJ-AUTO.png"))
```
...
cap = "**Figure 4.3**. *ACF and PACF plots for BAJ_F, BAJF, BHA, BPC*" 
  
knitr::include_graphics(c("./Stata/acf&pacf/acf_BAJAJFINSV.png",
                          "./Stata/acf&pacf/acf_BAJFINANCE.png"))

knitr::include_graphics(c("./Stata/acf&pacf/acf_BHARTIARTL.png",
                          "./Stata/acf&pacf/acf_BPCL.png"))
```
...
cap = "**Figure 4.4**. *Fitted plots for the first 5 stocks*" 
  
knitr::include_graphics(c("./Stata/FittedPlots/fitted_ADANIPORTS.png",
                          "./Stata/FittedPlots/fitted_ASIANPAINT.png"))

knitr::include_graphics(c("./Stata/FittedPlots/fitted_AXISBANK.png",
                          "./Stata/FittedPlots/fitted_BAJAJ-AUTO.png"))

knitr::include_graphics("./Stata/FittedPlots/fitted_BAJAJFINSV.png")
```
...
However, Stata does not have some similar functions as <code>auto_arima</code> 
...
series data with implement auto_arima()/auto.arima() function which Selects
