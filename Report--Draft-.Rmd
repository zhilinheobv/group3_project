...
```{r fig_cap5, echo = FALSE}
fig.cap5 = "**Figure 5.** *Residual Diagnosis*"
```
...
implement `auto_arima()`/`auto.arima()` function which Selects appropriate 
